...
class Ui_pdfMerger(object):
    def setupUi(self, pdfMerger):
        ...
        self.btnJuntar.setGeometry(QtCore.QRect(540, 500, 91, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btnWord = QtWidgets.QPushButton(pdfMerger)
        self.btnWord.setGeometry(QtCore.QRect(640, 500, 91, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.btnWord.setFont(font)
        self.btnWord.setStyleSheet("border-radius: 10px; border: 1px solid rgb(0,0,0);  background-color: #CDC99B;    color: white;")
    ...
    def retranslateUi(self, pdfMerger):
        ...
        self.btnJuntar.setText(_translate("pdfMerger", "JUNTAR\n"
" PDF"))
...
" SENHA"))
        self.btnWord.setText(_translate("pdfMerger", "PDF to\n"
" WORD"))
