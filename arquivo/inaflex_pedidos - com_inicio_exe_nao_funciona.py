...
class Pedidos(QMainWindow, Ui_mainWindow):
    def __init__(self, widget_pedidos, janela_cliente, direito, parent=None):
...
class JanelaCliente(QWidget, Ui_janelaMensagemCliente):
    def __init__(self, widget_pedidos, direito, parent=None):
        super().__init__(parent)
        super().setupUi(self)
        self.shortcut_procura = QShortcut(QKeySequence('return'), self)
    ...
    def ver_pedidos(self):
        ...
        self.widget_pedidos.setFixedSize(722, 414)
